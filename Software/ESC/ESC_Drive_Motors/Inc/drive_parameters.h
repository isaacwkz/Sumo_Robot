...
#define PID_TORQUE_KP_DEFAULT         3003       
#define PID_TORQUE_KI_DEFAULT         3081
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2403
#define PID_FLUX_KI_DEFAULT           3081
...
#define SPEED_LOOP_FREQUENCY_HZ       1000 /*!<Execution rate of speed   
                                                      regulation loop (Hz) */
#define PID_SPEED_KP_DEFAULT          6028/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V          28 /*!< Over-voltage 
                                                         threshold */
#define UD_VOLTAGE_THRESHOLD_V          14 /*!< Under-voltage 
                                                          threshold */
#if 0
...
#define FINAL_I_ALIGNMENT               19058 /*!< s16A */
